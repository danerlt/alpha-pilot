...
此文件保留为 facade 用于向后兼容 `from src.api.router import router` 的导入,
内容是把 9 个新 router 合并成一个 APIRouter 暴露。

新代码请直接 `from src.api.routers.<domain> import router as <domain>_router`,
...
# Re-export 共享依赖, 兼容老测试通过 `src.api.router.require_admin` 等路径访问.
...
from src.api.routers.account import router as _account_router
from src.api.routers.admin import router as _admin_router
from src.api.routers.auth import router as _auth_router
from src.api.routers.decisions import router as _decisions_router
from src.api.routers.health import router as _health_router
from src.api.routers.positions import router as _positions_router
from src.api.routers.reports import router as _reports_router
from src.api.routers.risk import router as _risk_router
from src.api.routers.runtime_config import router as _runtime_config_router
from src.api.routers.trades import router as _trades_router
